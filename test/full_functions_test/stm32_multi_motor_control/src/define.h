...
#define EFE_JOINT_MAX_POSITION (3517) // 89 deg
#define EFE_JOINT_MIN_POSITION (2620) // 3 deg
...
#define SFE_JOINT_MAX_POSITION (3045) // 290 (-70) deg
#define SFE_JOINT_MIN_POSITION (1570) // 75 deg
