...
#define EFE_JOINT_ALLOWABLE_POSITION_ERROR (10)
...
#define SFE_JOINT_FLEXED_DEGREE (75)
#define SFE_JOINT_EXTENSION_DEGREE (-70)
#define SFE_JOINT_FLEXED_ADC_VALUE (1570)    //  75 deg
#define SFE_JOINT_EXTENSION_ADC_VALUE (3045) // -70 deg
#define SFE_JOINT_ALLOWABLE_POSITION_ERROR (10)
